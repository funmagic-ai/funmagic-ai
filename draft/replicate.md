...
const output = await replicate.run(
  "vufinder/vggt-1b:35b7a45ef4430c677a6c71f5467ee0d98991502effe0d65bdbd8863fa205cc54",
  {
    input: {
      inputs: ["https://replicate.delivery/pbxt/NttVVVnd5x4l2kwGctcHSV4MmWztBlPoPeu4FxYR7d15uUH0/001.mp4"],
      to_base64: true,
