...
const { t } = useI18n();
const sectionKeys = ['acceptance', 'description', 'accounts', 'credits', 'acceptable', 'ip', 'liability', 'changes', 'contact'];
...
for (const [key] of __VLS_getVForSourceType((__VLS_ctx.sectionKeys))) {
    ...
    (__VLS_ctx.t(`terms.sections.${key}.title`));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
        ...{ class: "text-muted-foreground leading-relaxed" },
    });
    (__VLS_ctx.t(`terms.sections.${key}.content`));
}
__VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
