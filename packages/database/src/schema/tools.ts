...
export const toolTypes = pgTable('tool_types', {
  ...
  translations: jsonb('translations').notNull().default({ en: { displayName: '', description: '' } }),
...
export const tools = pgTable('tools', {
  ...
  translations: jsonb('translations').notNull().default({ en: { title: '', description: '', shortDescription: '' } }),
  isActive: boolean('is_active').notNull().default(true),
